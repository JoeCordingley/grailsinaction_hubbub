...
class PostIntegrationSpec extends Specification {
    ...
    def "Adding posts to user links posts to user"(){
        ...
        then: "The use has a list of posts attached"
    ...
    def "Ensure posts linked to a user can be retrieved"(){
        ...
        sortedPostContent == ['First','Second','Third'] //alphabetical order

    }

    def "Excercise tagging several posts with varius tags"() {
        ...
        then:
//        user.tags*.name.sort() == [ 'grails', 'groovy'] //both work .. investigate
