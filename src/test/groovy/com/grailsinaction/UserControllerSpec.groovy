...
class UserControllerSpec extends Specification {
    ...
    def "Registration command object for #loginId validate correctly"() {
        ...
        then: "the appropriate fields are flagged with errors"
        ...
        "Z"     | "password"   | "password"     | false            | "loginId"        | "size.toosmall"
    }
    ...
    def "Invoking the new register action via a command object"() {
        ...
        User.count() == 1
        Profile.count == 1
        User.findByLoginId("glen_a_smith").profile.email == "glen@bytecode.com.au"
    }
